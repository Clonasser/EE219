...
class Linear():
    ...
    def forward( self, x ):
        ...
        # print("weight's shape = ",self.weight.shape)
        ...
        # np.save( "/home/docker/workspace/2023EE219_LAB/projects/project/data/npy/temp.npy", result_clamp )
        return result_clamp 
...
class QKVCore():
    ...
    def forward( self, x ):
        ...
        for n in range(self.num_heads):
            ...
            # np.save( "/home/docker/workspace/2023EE219_LAB/projects/project/data/npy/temp.npy", score ) 
            score = self.softmax( score )
            # np.save( "/home/docker/workspace/2023EE219_LAB/projects/project/data/npy/temp1.npy", score )            
            h = self.matmul_2( score, v_h )
            np.save( "/home/docker/workspace/2023EE219_LAB/projects/project/data/npy/temp.npy", h ) 
            h_list.append(h)
